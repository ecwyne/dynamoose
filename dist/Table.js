...
class Table {
    ...
    init(next) {
        ...
        if (this.options.create) {
            this.describe()
                ...
                localTableReq = this.buildTableReq(table.name, table.schema, this);
                    ...
                    Q()
                        ...
                        return indexes.delete.reduce(function (cur, next) {
                            return cur.then(function () {
                                return table.deleteIndex(next.IndexName);
                            });
                        }, Q());
                    })
                        .then(function () {
                        return indexes.create.reduce(function (cur, next) {
                            return cur.then(function () {
                                return table.createIndex(localTableReq.AttributeDefinitions, next);
                            });
                        }, Q());
                    })
                        .catch(function (e) {
    ...
    updateTTL(next) {
        ...
        if (this.schema.expires && !this.base.endpointURL) {
            this.describeTTL().then(function (ttlDesc) {
                ...
                var params = {
                    ...
                    TimeToLiveSpecification: {
                        AttributeName: table.schema.expires &&
    ...
    buildTableReq(name, schema) {
        ...
        for (var globalIndexName in schema.indexes.global) {
            ...
            var rangeKeyName = schema.indexes.global[globalIndexName].indexes[globalIndexName]
                .rangeKey;
