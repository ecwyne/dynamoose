...
declare module 'dynamoose' {
    ...
    export function setDocumentClient(
        documentClient: _AWS.DynamoDB.DocumentClient,
    ): void;
    ...
    export class Model<ModelData> {
        ...
        populate<T>(
            path: string | PopulateOptions,
        ): Promise<Model<ModelData> & T>;
    }
